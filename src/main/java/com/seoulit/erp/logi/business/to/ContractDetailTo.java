...
@Alias("ContractDetailTo")
public class ContractDetailTo extends BaseTo{

	private String contractDetailNo, contractNo, itemCode, itemName, 
					unitOfContract, dueDateOfContract, contractAmount,
					unitPriceOfContract, sumPriceOfContract, mpsApplyStatus, 
					deliveryStatus, description, deliveryRemain, slipRegistStatus;
