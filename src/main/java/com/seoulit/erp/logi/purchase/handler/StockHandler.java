...
public class StockHandler {
	...
	public void registWarehousing(
			@RequestBody List<OrderInfoTo> orderInfoList
			,@RequestBody List<OrderDetailTo> orderDetailList
			,@RequestBody List<StockTo> stockList
			,@RequestBody List<WarehousingTo> warehousingList
			){
		
		purchaseServiceFacade.registWarehousing(
				orderInfoList, orderDetailList, stockList, warehousingList);
