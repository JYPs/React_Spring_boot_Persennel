...
public class MrpHandler {
    ...
    public List<MrpTo> findMrpList(
            @RequestParam() String mrpgStatus
    ) throws Exception {
    ...
    public List<MrpOpenTempTo> findMrpOpenTempList(
    ...
    public void registMrpGathering(
            @RequestBody List<MrpTo> MrpToList
    ) throws Exception {
    ...
    public List<MrpGatheringTo> findMrpGatheringList(
            @RequestParam String gatheringStatus
    ) throws Exception {
    ...
    public void batchMrpGathering(
            @RequestBody List<MrpGatheringTo> mrpGatheringList
    ) throws Exception {
