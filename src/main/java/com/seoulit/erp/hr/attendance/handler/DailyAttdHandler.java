...
public class DailyAttdHandler {
	...
	public List<DailyAttdTo> findDailyAttdList(
...
//        map.put("toDate",toDate);
	...
	public List<DailyAttdTo> findDailyAttdListByCondition(
...
//		map.put("deptCode", deptCode);
	...
	public void batchDailyAttd(
            @RequestBody List<DailyAttdTo> dailyAttdList
    ) throws Exception {

		for(DailyAttdTo dt :dailyAttdList ) {
			dt.setBasicDay(dt.getBasicDay().replaceAll("-", ""));
			dt.setTime(dt.getTime().replaceAll(":", ""));
		}
