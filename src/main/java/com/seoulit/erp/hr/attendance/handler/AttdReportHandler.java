...
public class AttdReportHandler {
    ...
    public List<OverNightReportTo> findOverNightAttdReport(
    ...
    public void batchOverNight(
            @RequestBody List<OverNightReportTo> overNightReportList
    ) throws Exception {
    ...
    public List<DailyAttdReportTo> findDailyAttdReport(
            @PathVariable String basicDate
    ) throws Exception {
        basicDate = basicDate.replaceAll("-","");
        return attendanceServiceFacade.findDailyAttdReport(basicDate);
    ...
    public void updateDailyAttdCloseYN(
            @RequestBody List<DailyAttdReportTo> dailyAttdReportList
    ) throws Exception {
    ...
    public List<DailyAttdReportTo> findUnClosedDailyAttdReport(
...
//        map.put("baseYearMonth", baseYearMonth);
    ...
    public List<MonthAttdReportTo> findMonthAttdReport(
            @RequestBody Map<String, Object> param
    ) throws Exception {
...
//        map.put("baseYearMonth", baseYearMonth);
    ...
    public List<DailyAttdReportTo> batchDailyAttdCloseYN(
            @RequestBody List<DailyAttdReportTo> dailyAttdReportList
    ) throws Exception {
    ...
    public List<MonthAttdReportTo> findClosedMonthAttdReport(
...
//        map.put("baseYearMonth", baseYearMonth);
    ...
    public void updateMonthAttdCloseYN(
            @RequestBody List<MonthAttdReportTo> monthAttdReportList
    ) throws Exception {
    ...
    public List<OverNightReportTo> findOverNightReportByCondition(
            @RequestBody Map<String, Object> param
    ) throws Exception {
