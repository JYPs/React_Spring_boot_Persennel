...
public class DayAnnualHandler{
    ...
    private List<DayAnnualTo> findAnnualMgt(
...
//		String standardYear = inData.getVariable("standardYear").getString();
    ...
    public List<DayAnnualTo> addDayAnnual(
            @RequestBody DayAnnualTo dayAnnualTO
    ) throws Exception {
    ...
    public List<DayAnnualTo> findDayAnnualListByCondition(
...
//        String approvalStatus = inData.getVariable("approvalStatus").getString();
    ...
    public void batchDayAnnual(
           @RequestBody List<DayAnnualTo> dayAnnualList
    ) throws Exception {
