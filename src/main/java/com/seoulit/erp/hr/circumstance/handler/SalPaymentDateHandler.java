...
public class SalPaymentDateHandler {
	...
	public List<SalPaymentDateTo> findSalPaymentDateList(
			@PathVariable String inputedYearMonth
	) throws Exception {
	...
	public void batchSalPaymentDate(
			@RequestBody List<SalPaymentDateTo> salPaymentDateList
	) throws Exception {
