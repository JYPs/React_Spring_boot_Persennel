...
public class PersonalAppointmentHandler{
	...
	public void batchPersonalAppointment(@RequestBody List<PersonalAppointmentTo> personalAppointmentList) throws Exception{
...
//	}	
	...
	public void batchPersonalAppointmentDetail(@RequestBody List<AppointmentTo> appointment,
			...
			@RequestBody List<PersonalAppointmentDetailTo> personalAppointmentDetail, @RequestBody List<EmployeeTo> employeeList)
			throws Exception {
	...
	public List<TempAppointmentTo> findAppointmentHistory(@RequestBody Map<String, Object> appointmentNoMap) throws Exception{
...
//		datasetBeanMapper.beansToDataset(outData, appointmentHistoryList, TempAppointmentTo.class);
	...
	public List<TempAppointmentTo> findCanceledAppointment(@RequestBody Map<String,Object> appointmentInfoMap) throws Exception{
//		PlatformData outData = (PlatformData) request.getAttribute("outData");
//		PlatformData inData = (PlatformData) request.getAttribute("inData");
//		String appointmentNo = inData.getVariable("appointmentNo").getString();
//		String appointmentDivision = inData.getVariable("appointmentDivision").getString();
