...
public class RegistrationHandler {
    ...
    public List<EmpInfoTo> findEmpCode(HashMap<String, String> param) throws Exception {
//		PlatformData inData = (PlatformData) request.getAttribute("inData");
//		PlatformData outData = (PlatformData) request.getAttribute("outData");
//		String empCode = inData.getVariable("empCode").getString();
//		map.put("empCode", empCode);
        return pmServiceFacade.findEmpCode(param);
    }
...
//		saveEmpImg(request, response);
    ...
    public void saveEmpImg(@RequestPart MultipartFile file,
                           @PathVariable String empCode) throws Exception {
